<template>
  <div class="w-full" border="b dark opacity-15 ">
    <div class="container px-6 py-6 mx-auto">
      <div class="flex justify-between items-center">
        <div class="flex justify-between min-w-full md:min-w-0">
          <div class="md:hidden mt-4">
            <button @click="showSideDrawer = true" type="button"
              class="rounded-md p-2 inline-flex text-gray-400 hover:text-gray-500 dark:bg-slate-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
              aria-expanded="false">
          ...
          <div class="">
            <NuxtLink to="/" class="text-2xl text-dark" decoration="none" self="center" mb="4" font="bold"
              whitespace="nowrap">
              FrontEnd FrameWorks</NuxtLink>
          </div>
        </div>
      ...
      <!-- drawer component -->
      <div id="drawer-navigation" :class="showSideDrawer ? 'translate-x-0' : '-translate-x-full'"
        class="bg-dark fixed z-40 top-0 left-0 h-screen transition-all duration-700 overflow-y-auto w-80" tabindex="-1"
        aria-labelledby="drawer-navigation-label">
        <button @click="showSideDrawer = false" type="button" data-drawer-dismiss="drawer-navigation"
          aria-controls="drawer-navigation"
          class="text-gray-200 bg-transparent hover:bg-gray-200 hover:text-gray-500 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        <div class="py-4 overflow-y-auto">
          <ul class="space-y-2 p-5">
            <NuxtLink to="https://github.com/Gruce/nuxt-tutorial">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                role="img" class="text-gray-200 h-6 w-6 ml-2 mt-2" width="0.97em" height="1em"
            ...
            <NuxtLink to="/table"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">MZ-table</span>
            </NuxtLink>
            <NuxtLink to="/table_v2"
              class="flex items-center p-2 text-base font-normal rounded-lg text-gray-200 hover:bg-gray-200 hover:text-gray-800">
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Jawy's table</span>
            </NuxtLink>
            <NuxtLink to="/skyTable"
              class="flex items-center p-2 text-base font-normal rounded-lg text-gray-200 hover:bg-gray-200 hover:text-gray-800">
              <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 transition duration-75" fill="currentColor" viewBox="0 0 20 20"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Sky Table</span>
            </NuxtLink>
            <NuxtLink to="/calculator"
              class="flex items-center p-2 text-base font-normal rounded-lg text-gray-200 hover:bg-gray-200 hover:text-gray-800">
              <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 transition duration-75" fill="currentColor"
            ...
            <NuxtLink to="/"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Ask Us</span>
            </NuxtLink>
          </ul>
        </div>
      </div>
